...
def create_historical_chart(spot_series: pd.Series, params: dict) -> go.Figure:
    ...
    fig.add_hline(
        ...
        line_dash="dash",
        line_color=COLORS['info'],
        annotation_text=f"Entry Spot: {params['spot_entry']:.2f}",
        annotation_position="right",
    )
    ...
    fig.add_hline(
        ...
        line_dash="dash",
        line_color=COLORS['breakeven'],
        annotation_text=f"Break-even: {params['spot_be']:.2f}",
        annotation_position="right",
    )
    ...
    fig.add_hline(
        ...
        line_dash="dot",
        line_color=COLORS['tbill'],
        annotation_text=f"Entry Bank Rate: {params['entry_bank_rate']:.2f}",
        annotation_position="right",
    )
...
def create_realtime_pnl_chart(pnl_data: dict, spot_series: pd.Series) -> go.Figure:
    ...
    fig.add_hline(
        ...
        line_dash="dash",
        line_color=COLORS['info'],
        annotation_text=f"Entry: {pnl_data['entry_spot']:.4f}",
        annotation_position="right",
    )
    ...
    fig.add_hline(
        ...
        line_dash="dash",
        line_color=COLORS['breakeven'],
        annotation_text=f"Break-even: {pnl_data['spot_be']:.4f}",
        annotation_position="right",
    )
...
def create_cushion_timeline(cushion_data: dict, trend_data: dict) -> go.Figure:
    ...
    # Generate projection
    days = list(range(0, days_remaining + 5))
    ...
    fig.add_vline(
        ...
        line_dash="dot",
        line_color=COLORS['info'],
        annotation_text=f"Maturity: Day {days_remaining}",
        annotation_position="top",
    )
    ...
    y_min = min(min(projected_spots), spot_be, current_spot) * 0.998
    y_max = max(max(projected_spots), spot_be, current_spot) * 1.002
